package com.loncoto.tdangularupload.utils;
...
public class FileStoreManager {
	...
	public File getStrorageRoot() {return storageRoot;}
	public void setStrorageRoot(File stroageRoot) {this.storageRoot = storageRoot;}
	
	public FileStoreManager() {
		log.info("constructeur FileStorageManager");
	}
